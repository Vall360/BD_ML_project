"""Training script optimized for running on Google Colab.

This variant of :mod:`trainer` automatically enables mixed-precision
training when a CUDA-enabled GPU is available.
"""
